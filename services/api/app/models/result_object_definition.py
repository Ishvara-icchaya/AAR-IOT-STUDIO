...
class ResultObjectDefinition(Base):
    __tablename__ = "result_object_definitions"
    ...
    terminate_node_id: Mapped[uuid.UUID] = mapped_column(
    ...
    workflow: Mapped["Workflow"] = relationship(back_populates="result_definitions")
